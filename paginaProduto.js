  ...
  fetch("dados.json")
    ...
    .then((corpo) => {
      ...
      if (document.title == "LANCER EVO") {
        ...
        document.getElementById("descricao").innerHTML = corpo.produtos[0].descricao;
        document.getElementById("precoCarro").innerHTML = `$${precoCarro}`;
        document.getElementById("precoEmReais").innerHTML = `R$${(precoCarro*valor).toFixed(2)}`;
        ...
        document.getElementById("descricao").innerHTML = corpo.produtos[1].descricao;
        document.getElementById("precoCarro").innerHTML = `$${precoCarro1}`;
        document.getElementById("precoEmReais").innerHTML = `R$${(precoCarro1*valor).toFixed(2)}`;
        ...
        document.getElementById("descricao").innerHTML = corpo.produtos[2].descricao;
        document.getElementById("precoCarro").innerHTML = `$${corpo.produtos[2].preco}`;
        document.getElementById("precoCarro").innerHTML = `$${precoCarro2}`;
        document.getElementById("precoEmReais").innerHTML = `R$${(precoCarro2*valor).toFixed(2)}`;
      }
    });
}
